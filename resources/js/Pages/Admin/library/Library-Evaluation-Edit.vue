...
function update() {
    ...
    // Assuming 'form' is your form data object
    axios.post("/ched/evaluation/update", form)
        .then(response => {
            // Handle successful response
            hasUnsavedChanges.value = false;
            
            // You might want to show a success message
            // For example, if you're using a notification system:
        ...
        .finally(() => {
            // Set updating state to false when done (whether success or error)
