<template>
    ...
    <content-container :hasSearch="true" :pageTitle="institution.institution.name" page="application" :hasTopButton="true" :hasFilters="true" :data_list="application_list">
    ...
    <Confirmation
        ...
        @close="toggleDeleteModal(null)"
        :selected="selectedForm"
        title="Delete Form"
        modaltype="deleteApplication"
        width="md"
        height="short"
    />
...
function createApplication() {
    router.post('/application/create', props.institution);
}

function submit() {
    router.get('/hei/program-application', query);
}
