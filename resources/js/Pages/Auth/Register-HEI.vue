                ...
                <form class="mx-auto" @submit.prevent="submit" method="POST">
                    ...
                    <div class="mt-4" v-show="form.institution">
                        ...
                        <select id="role" v-model="form.role" @change="checkRole()"
                            ...
                            <option class="text-gray-800" value="Vice-President for Academic Affairs">VPAA/Dean of Multiple Disciplines</option>
                            <option class="text-gray-800" value="Dean">Dean of a Specific Discipline</option>
