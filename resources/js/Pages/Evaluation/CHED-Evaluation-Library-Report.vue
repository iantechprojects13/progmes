...
function previewFile() {
    const url =
        submitReport.type === "monitoring"
            ? `/report/library/monitoring/${props.tool.id}/${submitReport.orientation}/view`
            : `/report/library/deficiency/${props.tool.id}/${submitReport.orientation}/view`;
...
function downloadFile() {
    const url =
        submitReport.type === "monitoring"
            ? `/report/library/monitoring/${props.tool.id}/${submitReport.orientation}/download`
            : `/report/library/deficiency/${props.tool.id}/${submitReport.orientation}/download`;
    window.open(url, "_blank");
}
...
function generate() {
    router.post("/report/library/generate", report, {
        onStart: () => {
