        ...
        <template v-slot:main-content>
            <div class="border-gray-400">
                <div class="overflow-x-auto">
                    <div class="px-3 md:px-10 pt-3 font-bold text-gray-600 text-base">
                        CMO Details
                    </div>
                    <div class="w-full flex flex-col justify-between p-3 md:px-10">
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full flex flex-col mt-2">
                                ...
                                <select id="discipline" v-model="form.discipline"
                                    class="py-1 px-3 h-10 text-sm border-2 border-gray-400 rounded m-1"
                        ...
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full flex flex-col mt-2">
                                ...
                                <input id="number" type="number" placeholder="CMO No." v-model="form.number"
                                    class="h-10 m-1 rounded text-sm border-2 border-gray-400" />
