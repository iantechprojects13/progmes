        ...
        <div class="mx-auto md:w-4/5 md:shadow-lg md:border md:rounded-2xl max-w-xl px-10 pb-10">
            ...
            <div class="mt-5">
                <form class="mx-auto" @submit.prevent="submit" method="POST">
                    ...
                    <div>
                        <div>
                            <label for="institution" class="mb-2 font-medium text-gray-900 dark:text-white">Higher Education
                                Institution</label>
                        </div>
                    ...
                    <div class="mt-3" v-if="role.isDean">
                        <div>
                            <label for="discipline"
                                class="mb-2 font-medium text-gray-900 dark:text-white">Discipline</label>
                        </div>
                    ...
                    <div class="mt-3" v-if="role.isPH">
                        <div>
                            <label for="program" class="mb-2 font-medium text-gray-900 dark:text-white">Program</label>
                        </div>
