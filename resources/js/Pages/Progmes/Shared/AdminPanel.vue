<template>
    <div class="px-3 md:px-7 pt-4 bg-white text-gray-600">
        <h1 class="text-2xl font-bold md:block inline">AdminPanel</h1>
        <div class="mt-3 w-full z-40 text-gray-700 font-bold text-sm md:pb-0 md:border-b-2 border-gray-400"
            ...
            <div ref="adminPanelContainer"
                class="relative transition-all duration-200 md:visible md:whitespace-nowrap h-60 md:h-auto md:border-none bg-stone-700 border border-gray-400 rounded overflow-hidden"
                ...
                <div class="md:bg-white w-full sm:flex-row md:block rounded-sm border-gray-500">
                    ...
                    <button
                        class="h-12 md:w-auto md:px-5 w-full md:hover:bg-stone-200 hover:bg-stone-600 md:hover:text-black md:text-gray-600 text-gray-200 rounded "
