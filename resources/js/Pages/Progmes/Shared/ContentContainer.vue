<template>
    <div class="h-auto mx-3 md:mx-8 mt-8 pb-10 mb-5 bg-white p-5 rounded">
        ...
        <div class="mt-5 w-full overflow-x-auto border-b-2 border-gray-400 whitespace-nowrap" v-show="hasNavigation">
