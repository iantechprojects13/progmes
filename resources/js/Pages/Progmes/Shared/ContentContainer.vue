<template>
    <div class="h-auto mx-3 md:mx-8 mt-8 pb-10 mb-5 bg-white p-5 rounded relative">
        ...
        <div class="mt-5 w-full overflow-x-auto border-b border-gray-400 whitespace-nowrap" v-show="hasNavigation">
            <slot name="navigation"></slot>
        </div>
        <div v-show="hasSearch || hasFilters" class="w-full py-3 mt-3 flex flex-col md:flex-row justify-between">
            <div>
    ...
    <!-- <div
        class="h-auto mb-5 mt-7 pt-0 mx-3 md:mx-8 rounded border border-gray-500 shadow shadow-gray-500 text-gray-700 text-sm">
        <div v-show="hasAction"
            ...
            <div v-show="placeholder" class="flex lg:w-80" :class="{ ' justify-end w-full relative': !hideSearch }">
                ...
                <button
                    ...
                    <i :class="[
                            { 'fas fa-search': hideSearch },
                            { 'fas fa-close': !hideSearch },
                        ]"></i>
                </button>
            </div>
        </div>
