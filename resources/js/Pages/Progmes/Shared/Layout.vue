<template>
    ...
    <div class="flex flex-col md:flex-row h-full bg-gray-200">
        <!-- Navigation -->
        <div
            class="fixed z-80 top-0 w-full h-full bg-black bg-opacity-70 md:hidden"
                    ...
                    >
                        <div class="flex-shrink-0">
                            <div class="md:hidden w-full text-right pt-2">
                                <button
                                    @click="toggleSideBar"
                                    class="border px-2.5 py-0.5 hover:bg-stone-800"
                                >
                            ...
                            <!-- Searchbox -->
                            <div
                                class="bg-gray-700 my-7 h-10 rounded-md relative"
                            >
                                <form class="h-full">
                                    <span
                        ...
                        <!-- Profile -->
                        <div
                            class="md:block flex-shrink-0 hidden relative"
                            @click="toggleSideBarUser"
                        >
                            <div>
                                <hr />
                                <div
                            ...
                            >
                                <Link
                                    class="block py-2 indent-3 hover:bg-stone-600"
                                >
                        ...
                        <div
                            class="absolute top-1/2 -right-4 text-black hidden md:block text-md"
                            :class="{
        ...
        <!-- Page Content -->
        <div
            class="w-full h-auto relative bg-slate-100 overflow-x-auto pt-16 md:pt-0"
        >
            <slot />
        </div>
    </div>
