<template>
  ...
  <div class="editor-container relative" ref="editorContainer">
    <div 
      class="flex flex-wrap gap-1 p-1 bg-blue-300 rounded-t-lg border border-b-10 border-gray-200 absolute -top-12 left-0 z-[996] w-full"
    >
    <button 
      @click.stop="editor?.chain().focus().toggleBold().run()"
      @mousedown.prevent
      class="tooltipForActions" 
      data-tooltip="Bold"
    ...
    >
      <i class="fas fa-bold"></i>
        ...
        <button 
          ...
          class="tooltipForActions" data-tooltip="Italic"
        ...
        <button 
          ...
          class="tooltipForActions" data-tooltip="List"
        ...
        <button 
          ...
          class="tooltipForActions" data-tooltip="Link"
      ...
      :class="{ 'rounded-t-lg': !isEditorFocused }" 
      @click="isEditorFocused = true"
    >
